...
# o &:name, também é chamado de shorthand, seria uma
# maneira curta de vc referenciar um atributo em uma iteracao
# ao inves de usarmos: user.map { |u| u.age }
# podemos utilizar:    user.map(&:age)
...
# o valor de um determinado indice, vc o mapeia como se
# fosse uma variavel
